...
<nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start" style="background-color: #660066 !important;">
        <div class="me-3">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-top">
        ...
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
          <button type="button" class="log-btn px-3 logout_btn_confirm" href="#" style="background-color: #660066 !important;"
